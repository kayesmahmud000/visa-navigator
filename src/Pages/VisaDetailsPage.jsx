        ...
        <div>
                        ...
                        <div>
                            <div className="card-body">
                                ...
                                <div className="card-actions flex flex-col ">
                                    ...
                                    <Link >  <button onClick={handleApply} className="btn bg-[#e63746] border-none text-white hover:bg-white hover:text-black">Apply </button></Link>
                                </div>
                            </div>
            ...
            {isModal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    ...
                    <button onClick={modalClose} className="btn  bg-[#e63746]  text-white hover:bg-white hover:border hover:border-[#e63746] hover:text-black">Apply</button>
                    </div>
                </form>
